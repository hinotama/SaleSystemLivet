...
namespace SaleSystemLivet.Services
{
    public class OrderService
    {
        ...
        public HttpResponseMessage AddOrderList(List<Order> orderList)
        {
            ...
            HttpResponseMessage response = commonServices.HttpRequest(HttpMethod.Post, apiControllerUrl + "/AddOrderList", jsonBody);
        ...
        public List<Order> ListOrder()
        {
            ...
            HttpResponseMessage response = commonServices.HttpRequest(HttpMethod.Get, apiControllerUrl + "/ListOrder", null);
            string responseData = response.Content.ReadAsStringAsync().Result;
